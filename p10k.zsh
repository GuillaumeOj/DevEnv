...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR_FOREGROUND='%0F'
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='\uE0B1'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR_FOREGROUND='%0F'
  ...
  # isn't in an svn or hg reposotiry. typeset -g POWERLEVEL9K_VCS_BACKENDS=(git)
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_BACKGROUND=0
  ...
  ##############[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]###############
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_BACKGROUND=4
  ...
  typeset -g POWERLEVEL9K_AWS_EB_ENV_BACKGROUND=4
